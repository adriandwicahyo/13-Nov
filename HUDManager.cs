...
public class HUDManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        kecepatanLari = player.GetComponent<gerak_Player>().kecepatan;
    }

    // Update is called once per frame
    void Update()
    {
        kecepatan = player.GetComponent<gerak_Player>().kecepatan;
        input_x = player.GetComponent<gerak_Player>().x;
        input_z = player.GetComponent<gerak_Player>().z;
